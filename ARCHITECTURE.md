...
- **Process**:
  ...
  4. Save to CSV (e.g., `CVEEmbeddings.csv`) with columns: `sentence_chunk`, `embedding`
...
1. **CVEEmbeddings.csv**: Must exist before running `theRag.py`; generated by `localEmbedding.py`
