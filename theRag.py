...
def askingLlamaForAdvice(cveDesp):
    ...
    #####testing stuff July 17th
    #user_input_csv = "testingAll.csv"
    user_input_csv = "CVE2024.csv"
    ...
    companyNameQuery = cveDesp
    user_questions = [companyNameQuery,]


    query_list = user_questions
